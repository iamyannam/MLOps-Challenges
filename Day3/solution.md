...
root@controlplane ~/code ➜  pip list
Package                                      Version
-------------------------------------------- -----------
a2wsgi                                       1.10.10
aiobotocore                                  3.5.0
...
root@controlplane ~/code ➜  uv pip compile requirements.in -o requireme
nts.txt
error: File not found: `requirements.in`

root@controlplane ~/code ➜  cd fraud-detection/

root@controlplane ~/code/fraud-detection ➜  uv pip compile requirements.in -o requirements.txt
Resolved 89 packages in 716ms
