...
_No real dataset is loaded by the scaffold—the training step is a deterministic toy that gives MLflow a .fit() call to observe. The focus of the lab is autolog configuration, not model quality._
